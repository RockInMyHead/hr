...
- ОБЪЯСНИ формат: мы просто побеседуем о работе и опыте
- Подчеркни: я буду задавать конкретные вопросы с примерами
- ОБЪЯСНИ: цель - лучше понять твои навыки и опыт
- Задай конкретный вопрос с примером (не о хобби!)
...
2. Задавать КОНКРЕТНЫЕ вопросы с ЯСНЫМИ ПРИМЕРАМИ
3. ОБЪЯСНЯТЬ, что именно ты хочешь узнать
4. ПРИВОДИТЬ конкретные примеры ситуаций
5. ДАВАТЬ контекст к вопросам
...
- ОБЯЗАТЕЛЬНО объясняй, ПОЧЕМУ ты задаешь вопрос ("Мне важно понять твой опыт в...")
- ПРИВОДИ конкретные примеры: "Например, если тебе нужно было..."
- УКАЗЫВАЙ конкретные сценарии: "Представь ситуацию, где..."
- ДОПОЛНЯЙ контекстом: "Это поможет мне оценить твои навыки..."
