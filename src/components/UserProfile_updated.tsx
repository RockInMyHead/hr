            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-3">
                  ...
                  {onOpenMBTITest && (
                    <Button onClick={onOpenMBTITest} className="w-full h-14 text-lg font-medium bg-white/5 border-white/10 text-white hover:bg-white/10 rounded-xl">
                      📋 Классический MBTI тест
                    </Button>
                  )}
                </div>
