...
ЗАДАЧА:
Создай понятное и дружелюбное приветствие, которое:
- Поприветствует кандидата
- ОБЪЯСНИТ: мы просто побеседуем о работе и опыте
- ПОДЧЕРКНЕТ: я буду задавать конкретные вопросы с примерами
- ОБЪЯСНИТ: цель - лучше понять навыки и опыт
- Задаст конкретный вопрос с примером ситуации

ОБЯЗАТЕЛЬНО:
- ОБЪЯСНЯЙ, ПОЧЕМУ задаешь вопрос
- ПРИВОДИ конкретные примеры
- НЕ спрашивай о хобби - сразу о рабочих ситуациях!

ПРИМЕР ХОРОШЕГО ВОПРОСА:
"Расскажи о ситуации, когда тебе пришлось объяснять сложную тему коллеге. Мне важно понять, как ты подходишь к объяснению сложных вещей."

СТИЛЬ:
- Дружелюбный и понятный
- Используй "ты"
- Объясняй ПОЧЕМУ задаешь каждый вопрос
...
Верни только текст приветствия.`;
    ...
    return `Привет! Меня зовут Анна, я HR-специалист. Сегодня мы просто побеседуем о твоем опыте и навыках - никакого стресса!

Я буду задавать конкретные вопросы с примерами ситуаций, чтобы лучше понять твой подход к работе. Начнем?

Расскажи о ситуации, когда тебе пришлось объяснять сложную тему коллеге или клиенту. Мне важно понять, как ты подходишь к объяснению сложных вещей простым языком.`;
  };
