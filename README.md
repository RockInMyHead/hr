...
HR Chat Companion - это современное веб-приложение для проведения HR-интервью с использованием искусственного интеллекта. Приложение создает персональный профиль кандидата на основе его ответов во время интервью.

## Основные возможности

### 🤖 AI-интервью
- **Умный HR-ассистент** на базе OpenAI GPT-4
...
- **Поделиться профилем** - Web Share API
...
Система использует специально разработанный промпт для анализа ответов кандидатов:
